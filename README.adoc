...
image:https://img.shields.io/github/languages/code-size/RoRoche/plantuml-gradle-plugin[GitHub code size in bytes]
...
image:https://img.shields.io/github/downloads/RoRoche/plantuml-gradle-plugin/total[GitHub All Releases]
image:https://img.shields.io/github/downloads/RoRoche/plantuml-gradle-plugin/1.0.0/total[GitHub Releases]

=== Issue tracking

image:https://img.shields.io/github/issues-raw/RoRoche/plantuml-gradle-plugin[GitHub issues]
image:https://img.shields.io/github/issues-closed/RoRoche/plantuml-gradle-plugin[GitHub closed issues]
